import { Typography, Container, Accordion, Fade, Zoom } from "@mui/material";
    ...
    >
      ...
      <Fade in={true} timeout={1500}>
        ...
        >
          ...
          you're a casual moviegoer or a die-hard cinephile, our diverse range
          of content caters to every taste and interest. Join our community of
          film enthusiasts as we embark on a journey through the magic of
          storytelling and the power of visual artistry. Lights, camera, action
          – let's discover the wonders of cinema together!
        </Typography>
      </Fade>
